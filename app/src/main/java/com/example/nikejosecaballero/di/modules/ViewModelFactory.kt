...
abstract class ViewModelModule {
    ...
    internal abstract fun postMainActivityVM(viewModel: MainActivityVM): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(SplashScreenActivityVM::class)
    internal abstract fun postSplashScreenActivityVM(viewModel: SplashScreenActivityVM): ViewModel
}